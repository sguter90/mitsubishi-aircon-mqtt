...
#define configSSID  "aircon-room1"                                                                                 //AP name (give every unit a unique name before flashing)
#define configPW    "home"                                                                                   //Password to connect to the AP
...
char mqtt_server[16]     = "192.168.1.156"; // mqtt broker
...
void setup()
{
  ...
  //wifiManager.resetSettings(); // reconfigure settings - uncommment + flash, then flash without this line
